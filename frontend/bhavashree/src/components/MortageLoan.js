...
const MortageLoan = () => {
  return (
    <div className="remittance-container">
      <Image />
      <div className="text">
        <h1>About Mortage Loan</h1>
        <LoanForm title="Apply For Mortage Loan" />
        <h3 style={{ color: "#2a364b" }}>
          <b>ELIGIBILITY</b>
        </h3>
        <p>
          <b>
            This Mortage loan scheme is available at selective branches only
          </b>
        </p>
        <br />
      ...
      <div className="text-container">
        <p>
          ...
          by the borrower.
          <br />
          <br />;<i class="fa-solid fa-circle-check"></i> No loan granted on
          third party gold ornaments.
          <br />
          <br />
        </p>
      </div>
